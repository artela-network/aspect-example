const fs = require('fs')
const bytecode = fs.readFileSync("/Users/likun/go/src/github.com/artela-network/aspect-example/basic/test/test/Counter.bin", "utf-8") // change the bin file it to your own
const abidata = fs.readFileSync("/Users/likun/go/src/github.com/artela-network/aspect-example/basic/test/test/Counter.abi", "utf-8") // change the abi json to your own
